...
def main():
    ...
    cb_hal_inst = cbhal.types[app_config.get_cb_type()]['module'].HardwareAbstractionLayer()
    ...
    if cb_hal_inst.is_simulator():
        sim = cbhal.types[app_config.get_cb_type()]['module'].SimulatorFrame(frame, cb_hal_inst)
